// Demo app. By default it uses the library source (:comeback). To check the *published* artifact
// instead, publish to Maven Local and build with -PuseMavenLocal:
//   ./gradlew :comeback:publishToMavenLocal :sample:assembleDebug -PuseMavenLocal
plugins {
...
android {
    namespace = "io.github.rajumark.hoverfly.comeback.sample"
    compileSdk = 36

    defaultConfig {
        applicationId = "io.github.rajumark.hoverfly.comeback.sample"
...
dependencies {
    ...
    if (providers.gradleProperty("useMavenLocal").isPresent) {
        ...
        implementation(project(":comeback"))
    }
}
