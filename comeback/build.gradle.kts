// Comeback: on-device smart replies. Pure Kotlin inference, model bundled in the AAR,
...
android {
    namespace = "io.github.rajumark.hoverfly.comeback"
    compileSdk = 36
...
mavenPublishing {
    ...
    // Maven Central needs signed artifacts; Maven Local and JitPack do not, so sign only
