...
/**
 * Kotlin port of comeback/features.py (identical to Moji's). Must produce the exact same ids as Python;
 * FeaturizerParityTest checks it against vectors exported by scripts/export_kotlin.py.
 *
